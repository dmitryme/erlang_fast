...
% dynamic templateRef
decode_field(Data, Instr = #templateRef{name = undef}, Context) ->
   %?debugFmt("Start to decode: pmap = ~p, ~p~n", [erlang_fast_utils:print_binary(Context#context.pmap), Instr]),
   {Msg, #context{dicts = D}, Data1} = decode(Data, Context),
   {Msg, Context#context{dicts = D}, Data1};

%static templateRef
decode_field(Data, Instr = #templateRef{name = Name}, Context = #context{template = T = #template{instructions = Instrs}}) ->
   %?debugFmt("Start to decode: pmap = ~p, ~p~n", [erlang_fast_utils:print_binary(Context#context.pmap), Instr]),
...
decode_field(Data, I = #typeRef{name = TypeName}, Context) ->
   %?debugFmt("Start to decode: pmap = ~p, ~p~n", [erlang_fast_utils:print_binary(Context#context.pmap), Instr]),
...
%decode2_test() ->
%   Context = create_fake_context("ebin/templates.xml"),
%   Data = <<
%   16#c0, 16#81, 16#06, 16#29, 16#39, 16#c3, 16#23, 16#5a, 16#35, 16#53, 16#6f, 16#20, 16#51, 16#a5, 16#82, 16#df,
%   16#82, 16#b0, 16#01, 16#70, 16#5c, 16#f4, 16#65, 16#27, 16#85, 16#fa, 16#3b, 16#09, 16#57, 16#c1, 16#40, 16#44,
%   16#41, 16#a5, 16#01, 16#c3, 16#80, 16#a5, 16#8a, 16#b0, 16#fa, 16#78, 16#2f, 16#b8, 16#0a, 16#e7, 16#80, 16#80,
%   16#06, 16#29, 16#39, 16#c4, 16#23, 16#5a, 16#35, 16#53, 16#6f, 16#20, 16#51, 16#a5, 16#82, 16#9d, 16#b0, 16#01,
%   16#63, 16#4c, 16#af, 16#16, 16#2c, 16#b2, 16#fc, 16#45, 16#50, 16#61, 16#d2, 16#73, 16#e8, 16#80, 16#a5, 16#86,
%   16#b0, 16#fc, 16#76, 16#9e, 16#a4, 16#80, 16#80, 16#06, 16#29, 16#39, 16#c5, 16#23, 16#5a, 16#35, 16#53, 16#6f,
%   16#20, 16#51, 16#a5, 16#85, 16#9d, 16#b0, 16#01, 16#71, 16#1b, 16#9c, 16#4a, 16#76, 16#db, 16#fe, 16#7f, 16#2d,
%   16#7e, 16#de, 16#01, 16#a9, 16#80, 16#a5, 16#86, 16#b0, 16#fb, 16#05, 16#59, 16#7c, 16#dc, 16#07, 16#8a, 16#80,
%   16#a5, 16#8a, 16#b0, 16#fc, 16#7a, 16#6e, 16#2c, 16#a8, 16#7c, 16#f0, 16#80, 16#85, 16#b1, 16#f9, 16#04, 16#3a,
%   16#3d, 16#28, 16#c2, 16#7e, 16#9f, 16#80, 16#a5, 16#8a, 16#b1, 16#f9, 16#26, 16#12, 16#e8, 16#00, 16#fd, 16#80,
%   16#80, 16#06, 16#29, 16#39, 16#c6, 16#23, 16#5a, 16#35, 16#53, 16#6f, 16#20, 16#51, 16#a5, 16#85, 16#9d, 16#b0,
%   16#01, 16#42, 16#60, 16#de, 16#1c, 16#3b, 16#a8, 16#fb, 16#7b, 16#44, 16#54, 16#07, 16#aa, 16#7b, 16#d1, 16#80,
%   16#a5, 16#83, 16#b0, 16#fa, 16#04, 16#19, 16#8e, 16#d7, 16#80, 16#85, 16#b1, 16#fa, 16#03, 16#68, 16#a4, 16#f9,
%   16#80, 16#c4, 16#86, 16#b0, 16#fb, 16#77, 16#7e, 16#ce, 16#b1, 16#84, 16#b1, 16#fa, 16#08, 16#01, 16#b2, 16#d0,
%   16#80, 16#06, 16#29, 16#39, 16#c7, 16#23, 16#5a, 16#35, 16#53, 16#6f, 16#20, 16#51, 16#a5, 16#83, 16#fd, 16#82,
%   16#84, 16#b0, 16#01, 16#42, 16#60, 16#c1, 16#16, 16#2e, 16#a4, 16#fb, 16#77, 16#1c, 16#fa, 16#8e, 16#80, 16#85,
%   16#b1, 16#fb, 16#00, 16#61, 16#d4, 16#f0, 16#80, 16#c4, 16#86, 16#b1, 16#fb, 16#80, 16#fb, 16#80, 16#06, 16#29,
%   16#39, 16#c8, 16#23, 16#5a, 16#35, 16#53, 16#6f, 16#20, 16#51, 16#a5, 16#85, 16#dd, 16#82, 16#b0, 16#01, 16#42,
%   16#60, 16#e7, 16#35, 16#12, 16#c3, 16#f9, 16#00, 16#63, 16#48, 16#92, 16#a8, 16#80, 16#a5, 16#83, 16#b0, 16#fb,
%   16#7f, 16#1c, 16#68, 16#d8, 16#00, 16#c1, 16#80, 16#85, 16#b1, 16#fc, 16#7f, 16#14, 16#ca, 16#ee, 16#80, 16#c4,
%   16#86, 16#b0, 16#f9, 16#00, 16#64, 16#02, 16#de, 16#cf, 16#84, 16#b1, 16#fc, 16#7f, 16#1b, 16#7d, 16#a2, 16#af,
%   16#80, 16#06, 16#29, 16#39, 16#c9, 16#23, 16#5a, 16#35, 16#53, 16#6f, 16#20, 16#51, 16#a5, 16#85, 16#fd, 16#82,
%   16#83, 16#b0, 16#01, 16#42, 16#60, 16#e4, 16#3a, 16#06, 16#90, 16#fa, 16#08, 16#3b, 16#fe, 16#dc, 16#80, 16#a5,
%   16#84, 16#b0, 16#fd, 16#77, 16#36, 16#ac, 16#aa, 16#80, 16#a5, 16#83, 16#b1, 16#fc, 16#0d, 16#d6, 16#e6, 16#80,
%   16#c4, 16#86, 16#b0, 16#fa, 16#08, 16#3b, 16#fe, 16#e2, 16#84, 16#b1, 16#fc, 16#77, 16#44, 16#82, 16#96, 16#80,
%   16#06, 16#29, 16#39, 16#ca, 16#23, 16#5a, 16#35, 16#53, 16#6f, 16#20, 16#51, 16#a5, 16#85, 16#fd, 16#82, 16#85>>,
%   {T, {Msg1, Context1, Data1}} = timer:tc(?MODULE, decode, [Data, Context]),
%   ?debugFmt("~p ~p~n", [T, Msg1]),
%   {T1, {Msg2, _Context2, _Data2}} = timer:tc(?MODULE, decode, [Data1, Context1]),
%   ?debugFmt("~p ~p~n", [T1, Msg2]).
